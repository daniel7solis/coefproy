...
CREATE TABLE IF NOT EXISTS `Paciente` (
    ...
    `fPrimCon` date, --fecha de la primera consulta, dato que me servira para saber si se tiene q llenar o no
    `fProxCita` date,
    `peso` int(3) NOT NULL,
    `ta` int(3) NOT NULL,
...
(3, '2014-02-25', '6:30am', 1, 4, 60, 2,1,1);
